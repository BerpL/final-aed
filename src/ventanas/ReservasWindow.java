...
public class ReservasWindow {
    ...
    private CampoFormulario campoCheckIn;
    private CampoFormulario campoCheckOut;
    private CampoFormulario campoNumHabitaciones;
    private ComboBox<String> cmbTipoPago;
    private CampoFormulario campoTotal;
    ...
    private VBox crearPanelFormulario() {
        ...
        cmbHuesped.getItems().addAll("Seleccionar huésped", "Juan Pérez", "María García");
        ...
        cmbHabitacion.getItems().addAll("Seleccionar habitación", "101 - Suite", "102 - Suite", "201 - Doble");
        ...
        campoCheckIn = new CampoFormulario("Check-In", 150);
        campoCheckOut = new CampoFormulario("Check-Out", 150);
        fila2.getChildren().addAll(campoCheckIn, campoCheckOut);
        
        HBox fila3 = new HBox(24);
        fila3.setAlignment(Pos.CENTER_LEFT);
        campoNumHabitaciones = new CampoFormulario("N° Habitaciones", 120);
        ...
        campoTotal = new CampoFormulario("Total", 150);
        campoTotal.getCampo().setEditable(false);
        campoTotal.setValor("S/. 750.00");
        
        fila3.getChildren().addAll(campoNumHabitaciones, panelTipoPago, campoTotal);
